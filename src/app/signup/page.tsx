...
import { signUp, signInWithGoogle, signInWithApple, setupRecaptcha, signInWithPhone } from '@/lib/auth';
  ...
  return (
    <div className="auth-container">
      ...
      <div className="auth-card" style={{ zIndex: 10 }}>
        ...
        <p className="auth-subtitle">Start tracking family expenses together</p>
          ...
          <div>
            {!otpSent ? (
              <form onSubmit={handleSendOtp}>
                <div className="input-group">
                  ...
                  <input
                    ...
                    required
                  />
                  <div id="recaptcha-container-signup" style={{ marginTop: 10 }}></div>
                </div>
                <button
                  className="btn btn-primary btn-lg"
                  type="submit"
              ...
              <form onSubmit={handleVerifyOtp}>
                <div className="input-group">
                  <label className="input-label" htmlFor="signup-otp">Verification Code</label>
                  <input
                    id="signup-otp"
                    className="input"
                    type="text"
